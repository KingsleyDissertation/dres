...
print("=== ORKNEY ENERGY BALANCE - 30MW WAVE + 19.4MW TIDAL (2019) ===")
...
axes[0].set_title("Orkney: Wind Generation vs Demand (2019)")
axes[0].legend()
...
plt.show()
print("Plot saved to DATA/outputs/network_wave30MW_tidal19.4MW.png")